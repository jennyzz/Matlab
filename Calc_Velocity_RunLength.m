...
if VelocityFlag == 1
    ...
    if Velocity_mean > VelMax
        error('myapp:argChk','Mean velocity > Maximum velocity limit for histogram, increase maximum velocity input')
    end
...
% Create ylabel
ylabel('Fraction of runs','FontWeight','demi','FontSize',14,...
    'FontName','Times New Roman');
